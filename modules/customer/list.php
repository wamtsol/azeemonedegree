            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td><?php echo curr_format(get_customer_balance($r['id'], ""));?></td>
                        ...
                        <td class="text-center">
                            <a href="customer_manage.php?tab=report_debit_credit&id=<?php echo $r['id'];?>" class="download-icon"><i class="fa fa-download" aria-hidden="true"></i></a>&nbsp;&nbsp;
