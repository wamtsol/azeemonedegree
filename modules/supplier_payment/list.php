                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <?php if($role["can_delete"]==1){?><a onclick="return confirm('Are you sure you want to delete')" href="supplier_payment_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a><?php }?>
                        </td>
                    </tr>
                    <?php 
                    $sn++;
